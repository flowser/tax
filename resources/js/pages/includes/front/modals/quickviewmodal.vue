                ...
                <div class="sp-img_area">
                  ...
                  >
                    <div class="single-slide red">
                      <img
                        src="themes/uren/assets/images/product/large-size/1.jpg"
                        alt="Uren's Product Image"
                      />
                    </div>
                    <div class="single-slide orange">
                      <img
                        src="themes/uren/assets/images/product/large-size/2.jpg"
                        alt="Uren's Product Image"
                      />
                    </div>
                    <div class="single-slide brown">
                      <img
                        src="themes/uren/assets/images/product/large-size/3.jpg"
                        alt="Uren's Product Image"
                      />
                    </div>
                    <div class="single-slide umber">
                      <img
                        src="themes/uren/assets/images/product/large-size/4.jpg"
                        alt="Uren's Product Image"
                      />
                    </div>
                    <div class="single-slide black">
                      <img
                        src="themes/uren/assets/images/product/large-size/5.jpg"
                        alt="Uren's Product Image"
                      />
                    </div>
                    <div class="single-slide golden">
                      <img
                        src="themes/uren/assets/images/product/large-size/6.jpg"
                        alt="Uren's Product Image"
                      />
                    </div>
                  </div>
                  ...
                  >
                    <div class="single-slide red">
                      <img
                        src="themes/uren/assets/images/product/small-size/1.jpg"
                        alt="Uren's Product Thumnail"
                      />
                    </div>
                    <div class="single-slide orange">
                      <img
                        src="themes/uren/assets/images/product/small-size/2.jpg"
                        alt="Uren's Product Thumnail"
                      />
                    </div>
                    <div class="single-slide brown">
                      <img
                        src="themes/uren/assets/images/product/small-size/3.jpg"
                        alt="Uren's Product Thumnail"
                      />
                    </div>
                    <div class="single-slide umber">
                      <img
                        src="themes/uren/assets/images/product/small-size/4.jpg"
                        alt="Uren's Product Thumnail"
                      />
                    </div>
                    <div class="single-slide black">
                      <img
                        src="themes/uren/assets/images/product/small-size/5.jpg"
                        alt="Uren's Product Thumnail"
                      />
                    </div>
                    <div class="single-slide golden">
                      <img
                        src="themes/uren/assets/images/product/small-size/6.jpg"
                        alt="Uren's Product Thumnail"
                      />
                    </div>
                  </div>
              ...
              <div class="col-xl-7 col-lg-6">
                <div class="sp-content">
                  <div class="sp-heading">
                    <h5>
                      <a href="#">Dolorem odio provident ut nihil</a>
                    </h5>
                  </div>
                  ...
                  <div class="sp-essential_stuff">
                    <ul>
                      <li>
                        Brands
                        <a href="javascript:void(0)">Buxton</a>
                      </li>
                      <li>
                        Product Code:
